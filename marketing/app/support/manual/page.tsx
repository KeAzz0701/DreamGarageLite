...
export const metadata: Metadata = {
  title: '操作マニュアル',
  description:
    '「ガレージ・カルテ」の各機能の使い方をご紹介します。ログイン方法から顧客・車両管理、見積作成、LINE連携まで。',
}
  ...
  return (
    <main>
      <PageHero
        eyebrow="MANUAL"
        title="操作マニュアル"
        description="「ガレージ・カルテ」の主な機能の使い方をご紹介します。導入前のイメージづくりにお役立てください。"
      />

      <section className="bg-background py-16 md:py-24">
        <div className="mx-auto flex max-w-4xl flex-col gap-6 px-4 md:px-6">
          {sections.map((section, index) => (
            <Reveal key={section.id} direction={index % 2 === 0 ? 'left' : 'right'}>
              <div id={section.id} className="scroll-mt-24 rounded-2xl border border-border bg-card p-6 md:p-8">
