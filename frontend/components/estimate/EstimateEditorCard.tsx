// frontend/components/estimate/EstimateEditorCard.tsx
...
export default function EstimateEditorCard() {
  const [items, setItems] =
    useState<EstimateItem[]>([]);
  ...
  async function pdf() {
    ...
    window.open(
      'http://localhost:3001/api/estimates/pdf',
      '_blank',
    );
